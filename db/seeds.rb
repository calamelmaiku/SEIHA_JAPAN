...
spots = [
  ...
  { name: "摩耶山", text: "摩耶山頂上からの夜景は、神戸の街と海が一望できる。", address: "兵庫県神戸市", latitude: 34.7070, longitude: 135.2383, group_name: "日本三大夜景" },
  { name: "稲佐山", text: "稲佐山からの夜景は、長崎港を中心に広がる光景が美しい。", address: "長崎県長崎市", latitude: 32.7446, longitude: 129.8772, group_name: "日本三大夜景" },
  ...
  { name: "神田祭", text: "神田明神の祭りで、神輿や山車の巡行が街中を賑わせる。", address: "東京都千代田区", latitude: 35.6981, longitude: 139.7671, group_name: "日本三大祭り" },
  { name: "喜連川温泉", text: "かつて喜連川藩の温泉場として栄え、歴史のある温泉地。肌に優しいアルカリ性単純温泉が特徴。", address: "栃木県さくら市", latitude: 36.6836, longitude: 139.9692, group_name: "日本三大美肌の湯" },
  { name: "斐乃上温泉", text: "古くから美肌効果があるとされ、地元の人々に親しまれてきた。アルカリ性単純温泉で、肌がすべすべになると言われている。", address: "島根県仁多郡奥出雲町", latitude: 35.1367, longitude: 133.0307, group_name: "日本三大美肌の湯" },
