...
groups = [
  ...
  { name: "日本三景", creator: "林春斎", text: "日本三景は以下の3つの名勝地を指す。全て海（沿岸）にある風景となっており、古くから詩歌に詠まれ、絵画に描かれていた。" },
  ...
  { name: "日本三古泉", creator: "日本書紀、風土記などに登場することに基づく", text: "日本書紀、風土記などに登場することに基づいた三古湯。" },
  { name: "日本三大美肌の湯", creator: "", text: "日本温泉協会による日本三大美肌の湯。" },
  { name: "日本三大秘境", creator: "", text: "日本三大秘境は、日本の中でも特に自然が美しく、人里離れた秘境とされる3つの地域を指す。" }
]
